...
winsize = 10; %# Number of terms in each window
...
%######################################################################
	...
	feature_matrix = [SConc1,LConc1,SConc2,LConc2,SConc3,LConc3];
...
pwd = 'C:\University\ECE-9601A\Project\Project_Dataset\PU_corpora\pu_corpora_public\pu2\mails/*.txt';
files=dir(pwd);
